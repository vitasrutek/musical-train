...
var
   ...
   i: integer;
begin
     ExcelFileName := PDsoubor;        //replace file name with the name of your file
...
myxlBook.Save;
myxlBook.Close(True,soubor); //Saves the changes to mentioned file//
myxlBook.Disconnect;
FreeAndNil(myxlBook);
myxlApp.Disconnect;
myxlApp.Quit;
...
var
   ...
   ExcelApplication, ExcelWorkbook, ExcelWorksheet: Variant;
begin
     ExcelFileName := soubor;        //replace file name with the name of your file
     ExcelApplication := Null;
     ExcelWorkbook := Null;
     ExcelWorksheet := Null;
      try
                   ...
                   begin
                        ...
                        If VarIsNull(ExcelWorksheet) = False then
                           begin
                                ...
                                ExcelWorksheet.Cells[k1,k2] := co;                //[row,column], in this case, text is added to Cell A1
